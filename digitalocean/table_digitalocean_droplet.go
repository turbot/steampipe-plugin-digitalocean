	...
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			},
			{
				...
				Description: "Information about the base image used to create the Droplet instance.",
			},
			{
				Name:        "kernel",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Kernel"),
			...
			{
				Name:        "next_backup_window_start",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("NextBackupWindow.Start").Transform(timestampToIsoTimestamp),
				Description: "Start time of the window during which the backup will start.",
			},
			{
				Name:        "next_backup_window_end",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("NextBackupWindow.End").Transform(timestampToIsoTimestamp),
				Description: "End time of the window during which the backup will start.",
			},
			{
				Name:        "private_ipv4",
				Type:        proto.ColumnType_IPADDR,
				Transform:   transform.FromMethod("PrivateIPv4"),
				Description: "Private IPv4 address of the Droplet.",
			},
			{
				Name:        "public_ipv4",
				Type:        proto.ColumnType_IPADDR,
				Transform:   transform.FromMethod("PublicIPv4"),
				Description: "Public IPv4 address of the Droplet.",
			},
			{
				Name:        "public_ipv6",
				Type:        proto.ColumnType_IPADDR,
				Transform:   transform.FromMethod("PublicIPv6"),
			...
			},
			{
				...
				Description: "Information about region that the Droplet instance is deployed in.",
			},
			{
				Name:        "region_slug",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Region.Slug"),
				Description: "The unique slug identifier for the region the Droplet is deployed in.",
			},
			{
				Name:        "size",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Size"),
				Description: "Information about the size of the Droplet. Note: Due to resize operations, the disk column is more accurate than the disk field in this size data.",
			},
			{
				Name:        "size_slug",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Size.Slug"),
			...
			},
			{
				Name:        "urn",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromMethod("URN"),
			...
			// Steampipe standard columns
			{
				Name:        "akas",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromMethod("URN").Transform(ensureStringArray),
