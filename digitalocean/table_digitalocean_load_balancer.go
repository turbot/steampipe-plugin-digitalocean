...
func tableDigitalOceanLoadBalancer(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: commonColumns([]*plugin.Column{
			...
			{Name: "size_slug", Type: proto.ColumnType_STRING, Transform: transform.FromField("SizeSlug"), Description: "The size of the load balancer. The available sizes are \"lb-small\", \"lb-medium\", or \"lb-large\"."},
